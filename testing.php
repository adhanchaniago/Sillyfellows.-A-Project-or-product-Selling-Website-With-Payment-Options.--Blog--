		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight">
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					...
					<li><a href="projects.php">CG Projects</a></li>
			...
			<div class="colorlib-footer">
				<h1 id="colorlib-logo" class="mb-4"><a href="index.html" style="background-image: url(images/bg_1.jpg);">Silly <span>Fellows</span></a></h1>
				<div class="mb-4">
					<h3>Join Telegram for More Updates</h3>
					<form action="#" class="colorlib-subscribe-form">
            <div class="form-group d-flex">
            	
              <button class="mt-2 btn btn-white submit"><a href="" class="mb-4 sidebar-heading"><span class="icon-paper-plane"></span> Click to Join </a></button>
            </div>
          </form>
				</div>
					...
					<center><a href="index.php" class="img img-2"> <img src="sf.png"></a></center>
	    				<div class="row pt-md-4">
							   ...
							   <br>
								...
								<p>Stock Manager In PHP With Source CodeStock Manager In PHP With Source CodeStock Manager In PHP With Source CodeStock Manager In PHP With Source CodeStock Manager In PHP With Source CodeStock Manager In PHP With Source CodeStock Manager In PHP With Source CodeStock Manager In PHP With Source CodeStock Manager In PHP With Source</p>	
								<p><?php echo $row["sub_cont"]; ?></p>	
...
{					?>
	            ...
	            <div class="sidebar-box ftco-animate">
	              ...
	              <form action="#" class="subscribe-form">
	                <div class="form-group">
	                 <button class="mt-2 btn btn-white submit"><a href="" class="mb-4 sidebar-heading"> Click to Join</a></button>
	                </div>
	              </form>
	            </div>
