...
<div class="container">
    <div class="row">
		...
		<h2>Buy Now</h2>
		<h3><b>Note:</b> If you already made purchase Check mail id for product and login details</h3>
		<h3>Send the Amount to this paytm number <b>1234567890 </b>and enter the transaction id below to complete the purchase</h3>
		<h3><b>Note*</b>Send the Exact Price amount to complete the Transaction Else Transaction Wont be Completed. For Quires Contact <a href="https://t.me/silly_fellows">@silly_fellows </a>on Telegram</h3>
		<h3>After Successful Purchase The Product Download Links Along with Login User Details will be sent to Your Mail address</h3>
          <form action="finalpay.php" method="POST">
		  <label>Enter Mail Id</label><br>
		  <input type="text" name="email"><br>
		  <label>Enter Transaction Id</label><br>
		  <input type="text" name="trns"><br><br>
		  <label>Enter Refer Code</label><br>
		  <input type="text" name="refer"><br><br>
...
<div class="container">
    <div class="row">
        <div class="jumbotron"><center>
		<h2><b>Dont have Paytm Account Contact Us For Other Payments Method :-</b></h2>
		<h2> Telegram :- <a href="https://t.me/silly_fellows">@silly_fellows </a><h2>
		<h2> Mail id :- sellyfellows@gmail.com </a><h2>
...
<div class="container">
    <div class="row">
		...
		<h3><b>Note:</b> If you already made purchase Check mail id for product and login details</h3>
		<h3>Send the Amount to this paytm number <b>1234567890 </b>and enter the transaction id below to complete the purchase</h3>
		<h3>After Successful Purchase The Product Download Links will be sent to Your Mail address</h3>
          <form action="finalpay.php" method="POST">
		  <label>Enter Transaction Id</label><br>
		  <input type="text" name="trns"><br><br>
		  <input type="hidden" name="id" value="<?php echo $id ?>">
		  <input type="hidden" name="email" value="<?php echo $_SESSION['login_user2']; ?>">
		  <input type="submit" name="check" value="check">
		  </center>
		  </form>
        </div>
...
<div class="container">
    <div class="row">
        <div class="jumbotron"><center>
		<h2><b>Dont have Paytm Account Contact Us Through For Other Payments Method :-</b></h2>
		<h2> Telegram :- <a href="https://t.me/silly_fellows">@silly_fellows </a><h2>
		<h2> Mail id :- sellyfellows@gmail.com </a><h2>
