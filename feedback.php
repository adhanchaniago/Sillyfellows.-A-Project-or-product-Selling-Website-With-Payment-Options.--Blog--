		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight">
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					...
					<li class="colorlib-active"><a href="FeedBack.php">FeedBack</a></li>
...
if(isset($_POST['feedback'])){
	...
	$email = $_POST['email'];
	$des = $_POST['des'];
	$sql = "insert into feedback(f_id, title, email, feedback) values('' , '$title','$email','$des')";
	...
	echo '<h2 color:"red">Feedback is Sent Thank you For your feedback we will imporve.</h2><br>';
}

?>
	        </div><h2 >Send Feedback. So We Can Improve Our Services.</h2><br>
	          ...
	          <div class="col-lg-6 d-flex">
	            <form action="" method="post"class="bg-light p-5 contact-form">
	              ...
	              <div class="form-group">
				   ...
				   <div class="form-group">
	                <textarea name="des" id="" cols="30" rows="7"  class="form-control" placeholder="Your Feedback" required></textarea>
	              </div>
				  
	              <div class="form-group">
	                <input type="submit" name ="feedback" value="Send Message" class="btn btn-primary py-3 px-5">
	              </div>
	            </form>
